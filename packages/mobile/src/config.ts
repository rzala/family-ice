 ...
 *   3. hard fallback
 *
 * Defaults point at the deployed backend (familyice.prod.trafty.com) so a device demo works
...
export const API_BASE =
  process.env.EXPO_PUBLIC_API_BASE ?? extra.apiBaseUrl ?? 'https://familyice.prod.trafty.com';
export const WS_URL =
  process.env.EXPO_PUBLIC_WS_URL ?? extra.wsUrl ?? 'wss://familyice.prod.trafty.com/ws';
