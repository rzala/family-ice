---
name: speckit-review-toolkit-peer-review
description: Review design artifacts (specs, plans, tasks) before implementation to
  catch issues early.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: review-toolkit:commands/peer-review.md
user-invocable: true
