---
name: speckit-e2e-gates-e2e-init
description: Initialize E2E gating framework with tech stack discovery and Playwright
  scaffolding.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: e2e-gates:commands/speckit.e2e.init.md
user-invocable: true
