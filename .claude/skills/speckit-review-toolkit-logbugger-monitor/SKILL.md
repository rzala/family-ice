---
name: speckit-review-toolkit-logbugger-monitor
description: Analyze new LogBugger error groups and write root cause suggestions into
  the report.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: review-toolkit:commands/logbugger-monitor.md
user-invocable: true
