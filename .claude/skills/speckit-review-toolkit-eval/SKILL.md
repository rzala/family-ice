---
name: speckit-review-toolkit-eval
description: Run code quality evaluation using CLI linters and optionally external
  AI reviewers (Codex, Gemini).
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: review-toolkit:commands/eval.md
user-invocable: true
